...
export default function Datetime({
  ...
  return (
    <div className={`flex items-center space-x-2 opacity-80 ${className}`}>
      ...
      {/*  } p inline-block h-6 w-6 min-w-[1.375rem] fill-skin-base`}*/}
      {/*  aria-hidden="true"*/}
      {/*>*/}
      ...
      <IconCalendar className="p text-scale-900" strokeWidth={2} />
      {modDatetime ? (
        <span className={`italic ${size === "sm" ? "p text-sm" : "p text-base"}`}>
          Updated:
        </span>
      ) : (
